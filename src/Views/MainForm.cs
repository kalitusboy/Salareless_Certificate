...
namespace CertificateApp.Views
{
    ...
    {
        // خانات إعدادات الموقع الإداري (اقتراح المستخدم)
        ...
        public MainForm()
        {
            this.Text = "نظام إدارة وتسيير شهادات عدم العمل بأجر - نسخة مفتوحة المصدر";
            ...
            try {
                ...
                LoadData();
                LoadAdminSettings(); // تحميل المراجع الجغرافية المحفوظة سابقاً
            } catch { }
        }

        private void InitializeComponent()
        {
            // لوحة جانبية لإدخال البيانات والإعدادات
            ...
            // قسم إعدادات المراجع الإدارية (الولاية / الدائرة / البلدية)
        ...
        private void LoadAdminSettings()
        {
            ...
            txtSettingsWilaya.Text = settings.Item1;
            txtSettingsDaira.Text = settings.Item2;
            txtSettingsBaladia.Text = settings.Item3;
        }
        ...
        {
            if (e.RowIndex >= 0 && gridView.SelectedRows.Count > 0)
            {
        ...
        private void BtnSave_Click(object? sender, EventArgs e)
        {
            ...
            // استخدام تاريخ الكمبيوتر اللحظي تلقائياً لحفظ وقت إصدار الشهادة
            ...
            MessageBox.Show("تم حفظ بيانات المستفيد والشهود بنجاح.");
            LoadData();
        }
        ...
        // دالة الطباعة الديناميكية بالكامل بناءً على مراجع المستخدم وتاريخ الكمبيوتر
        private void RenderCertificateDynamicStyle(object sender, PrintPageEventArgs e)
        {
            ...
            // جلب تاريخ الكمبيوتر الحالي بصيغة اليوم/الشهر/السنة الرسمية
            string computerDateStr = DateTime.Now.ToString("dd/MM/yyyy");

            // جلب أسماء المراجع المدخلة والمحفوظة في خانات الإعدادات
            ...
            // 1. ترويسة الجمهورية ومراجع جهة الإصدار الديناميكية
            ...
            // 7. التوقيعات والتواريخ مدمج بها تاريخ الكمبيوتر واسم البلدية تلقائياً
            ...
            // 8. مربع الاسم اللاتيني أسفل الورقة
